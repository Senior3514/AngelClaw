#!/usr/bin/env bash
# ============================================================================
# AngelClaw AGI Guardian -- Linux Server Installer (V7.0.0)
#
...
echo -e "${B}${C}  V7.0.0 -- Singularity${N}"
echo -e "${B}${C}================================================${N}"
echo ""
...
echo "    docker logs angelclaw-cloud-1 -f    # cloud logs"
echo ""
echo "  Multi-tenancy:"
...
echo -e "  ${C}AngelClaw V7.0.0 -- Singularity -- guardian angel, not gatekeeper.${N}"
echo ""
