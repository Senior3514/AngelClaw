# ============================================================================
# ANGELGRID V1 — Windows ANGELNODE Installer (Pilot)
#
# Installs the ANGELNODE agent only, connecting to a remote ANGELGRID Cloud.
...
# Helpers
# ---------------------------------------------------------------------------
function Write-Step  { param($msg) Write-Host "[ANGELGRID] $msg" -ForegroundColor Cyan }
...
Write-Host "   ANGELGRID V1 — Windows ANGELNODE Installer (Pilot)" -ForegroundColor Cyan
...
$configContent = @"
# ANGELGRID environment — generated by installer on $timestamp
...
Write-Host "   ANGELNODE installed successfully!"                     -ForegroundColor Green
Write-Host "======================================================" -ForegroundColor Green
Write-Host ""
