# ============================================================================
# AngelClaw AGI Guardian -- Windows Client Installer (V10.0.0)
#
...
Write-Host "   V10.0.0 -- Seraph (Native Python Agent)"              -ForegroundColor Cyan
Write-Host "================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "  AngelClaw V10.0.0 -- Seraph" -ForegroundColor Cyan
