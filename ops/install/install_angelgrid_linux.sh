#!/usr/bin/env bash
# ============================================================================
# ANGELGRID V1 — Linux Installer (Pilot)
#
# Installs the full ANGELGRID stack (ANGELNODE + Cloud + Ollama) on a Linux
...
echo ""
echo -e "${B}${C}╔══════════════════════════════════════════════╗${N}"
echo -e "${B}${C}║   ANGELGRID V1 — Linux Installer (Pilot)     ║${N}"
...
# ANGELGRID environment — generated by installer on $(date -u +"%Y-%m-%dT%H:%M:%SZ")
...
# ---------------------------------------------------------------------------
log "Building and starting ANGELGRID stack..."
...
echo ""
echo -e "${B}${G}╔══════════════════════════════════════════════╗${N}"
echo -e "${B}${G}║   ANGELGRID V1 installed successfully!       ║${N}"
echo -e "${B}${G}╚══════════════════════════════════════════════╝${N}"
echo ""
...
echo -e "  ${C}Guardian angel, not gatekeeper.${N}"
echo ""
