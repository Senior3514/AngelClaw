"""AngelClaw V7.4.0 — Dark Web Radar: Extended Threat Intelligence & Dark Web Monitoring API routes."""
...
def darkweb_analyze_sbom(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), req: dict = {}):
...
def darkweb_scan_dependencies(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), req: dict = {}):
    from cloud.services.supply_chain import supplyChainService_service
