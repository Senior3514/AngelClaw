...
@router.post("/orient")
def ascendant_orient(
    observation_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")
):
    from cloud.services.ooda_loop import oODALoopService_service
...
@router.post("/decide")
def ascendant_decide(
    orientation_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")
):
    from cloud.services.ooda_loop import oODALoopService_service
...
@router.post("/act")
def ascendant_act(decision_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")):
    from cloud.services.ooda_loop import oODALoopService_service
...
def ascendant_get_decisions(
    tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), limit: int = 20
):
    from cloud.services.ooda_loop import oODALoopService_service
...
@router.post("/heal")
def ascendant_heal(diagnosis_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")):
    from cloud.services.self_healing import selfHealingService_service
...
def ascendant_verify_healing(
    action_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")
):
    from cloud.services.self_healing import selfHealingService_service
...
@router.get("/status")
def ascendant_status_2(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")):
    from cloud.services.self_healing import selfHealingService_service
...
@router.post("/prevent")
def ascendant_prevent(
    prediction_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")
):
    from cloud.services.breach_prevention import breachPreventionService_service
...
def ascendant_get_predictions(
    tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), min_probability: float = 0.5
):
    from cloud.services.breach_prevention import breachPreventionService_service
...
@router.get("/status")
def ascendant_status_3(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")):
    from cloud.services.breach_prevention import breachPreventionService_service
