...
@router.post("/orient")
def ascendant_orient(observation_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")):
    from cloud.services.ooda_loop import oODALoopService_service
    return oODALoopService_service.orient(tenant_id, observation_id)

@router.post("/decide")
def ascendant_decide(orientation_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")):
    from cloud.services.ooda_loop import oODALoopService_service
...
def ascendant_verify_healing(action_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")):
    from cloud.services.self_healing import selfHealingService_service
...
@router.post("/prevent")
def ascendant_prevent(prediction_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")):
    from cloud.services.breach_prevention import breachPreventionService_service
