...
def vault_scan_content(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), content: str, req: dict = {}):
...
def vault_discover_sensitive(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), scan_target: str):
    from cloud.services.data_classification import dataClassificationService_service
...
def vault_get_lineage(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), asset_id: str):
    from cloud.services.data_classification import dataClassificationService_service
