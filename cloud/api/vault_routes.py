...
def vault_discover_sensitive(
    scan_target: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")
):
    from cloud.services.data_classification import dataClassificationService_service
