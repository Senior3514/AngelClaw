...
def apex_start_pentest(target: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), scope: str = 'internal'):
...
def apex_verify_remediation(finding_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")):
    from cloud.services.pentest_auto import pentestAutoService_service
...
def apex_execute_phase(campaign_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), phase: int = 0):
    from cloud.services.red_team import redTeamService_service
