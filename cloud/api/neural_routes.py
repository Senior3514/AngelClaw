...
def neural_analyze_flow(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), req: dict = {}):
...
def neural_detect_beaconing(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), req: dict = {}):
    from cloud.services.traffic_analysis import trafficAnalysisService_service
    return trafficAnalysisService_service.detect_beaconing(tenant_id, req)

@router.post("/detect-exfiltration")
def neural_detect_exfiltration(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), req: dict = {}):
    from cloud.services.traffic_analysis import trafficAnalysisService_service
    return trafficAnalysisService_service.detect_exfiltration(tenant_id, req)

@router.post("/detect-lateral-movement")
def neural_detect_lateral_movement(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), req: dict = {}):
    from cloud.services.traffic_analysis import trafficAnalysisService_service
...
def neural_detect_tunneling(tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID"), req: dict = {}):
    from cloud.services.dns_security import dNSSecurityService_service
