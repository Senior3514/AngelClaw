...
def ghost_get_interactions(
    honeypot_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")
):
    from cloud.services.deception_depth import deceptionDepthService_service
...
def ghost_execute_mutation(
    policy_id: str, tenant_id: str = Header("dev-tenant", alias="X-TENANT-ID")
):
    from cloud.services.moving_target import movingTargetService_service
